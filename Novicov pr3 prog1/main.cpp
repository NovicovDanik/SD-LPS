...
int Adaugare(int &n, int a[], int val); //La intrare: n - numarul de elemente, a - tabloul de inaltime, val - element adaugat; La iesire: n - mareste cu 1, a - tabloul
...
int main()
{
    ...
    int pozitia;
    int inaltime[NMAX] = { 171, 176, 174, 173, 172, 175, 177, 178, 180, 179, 161, 162, 163, 164, 165, 166, 167, 168, 169, 170 };
    ...
    do
    {
        ...
        cout << "\n3. De aranjat un tabel de inaltimea in ordine crescatoare";
        ...
        switch(key)
        {
            ...
            case 5:
                do
                {
                    ...
                    cin >> valadaug;
                } while(valadaug < 130 || valadaug > 210);
                do
                {
                ...
                {
                    case 1:
                        Adaugare(n, inaltime, valadaug); // Inceput
                    break;
                    case 2:
                        Adaugare(n, inaltime, valadaug, 'N'); // Capat
                    break;
                    case 3:
                        do
                        {
                        ...
                        Adaugare(n, inaltime, valadaug, pozitia); // Inaite de p
                    break;
                    case 4:
                        do
                        {
                       ...
                       Adaugare(n, inaltime, valadaug, pozitia, 'N'); // Dupa p
                    break;
                }
